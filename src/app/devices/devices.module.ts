...
@NgModule({
  declarations: [DeviceListComponent, DeviceDetailsComponent, CustomersFormComponent, SellersFormComponent, DeviceMessagesComponent, DeviceIdentificationComponent, DeviceStatusComponent, DeviceInfoComponent],
  imports: [
    CommonModule,
    SharedModule,
